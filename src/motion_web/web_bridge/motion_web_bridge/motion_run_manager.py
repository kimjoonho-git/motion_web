...
class MotionRunManager(Node):
    ...
    This node is intentionally separate from the manual jog/action supervisor.
    Motion file execution has its own lifecycle and publishes combined motor
    setpoints directly to /motion_control/motor_command.
    """
    ...
    def __init__(self) -> None:
        ...
        self.motor_command_topic = str(
            self.declare_parameter('motor_command_topic', '/motion_control/motor_command').value
        )
